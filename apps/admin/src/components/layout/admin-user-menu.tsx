  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      <button
        ...
        className="flex h-10 items-center gap-1.5 sm:gap-2.5 rounded-lg border border-border/70 bg-card/60 px-2 transition-all duration-200 hover:bg-secondary hover:border-border hover:shadow-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 cursor-pointer"
      >
        <Avatar
      ...
      {isOpen && (
        ...
        >
          {/* User Profile Card */}
          <div className="border-b border-border/60 p-3 bg-secondary/30 rounded-lg mb-1">
